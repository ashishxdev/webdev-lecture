...
async function getSongs(folder) {
    currFolder = folder;
    let a = await fetch(`http://127.0.0.1:3000/Lecture 84 Project/${folder}/`)
    ...
    for (const song of songs) {
        songUl.innerHTML = songUl.innerHTML + `<li> 
                            ...
                            <div class="playnow">
                                <span>Play Now</span>
                            <img class="invert" src= "img/play.svg" alt="" style="width: 20px;">
                            </div>
                            </li>`
    }
...
const playmusic = (track, pause = false) => {
    ...
    currentsong.src = `http://127.0.0.1:3000/Lecture 84 Project/${currFolder}/` + track
    if (!pause) {
        currentsong.play()
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/")) {
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
                        ...
                        <img src="http://127.0.0.1:3000/Lecture 84 Project/songs/${folder}/cover.jpg" alt="">
...
async function main() {
    ...
    // Display all the functions on the page
    displayAlbums()
...
// Add event listener to hamburger close
